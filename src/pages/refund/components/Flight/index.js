            ...
            .then(res => {
              axios('/api/notify/addNotify', {
                ...
                data: {
                  ...
                  msg: JSON.stringify({
                    type: 2,
                    msg: '您的机票订单退款成功，退回金额为'+price+'元，退回至账户余额',
                  })
                }
              }).then(res => res.data)
                .then(res => {
            ...
            <Row style={{margin: '20px 0'}}>
              <Col span={24}>
                <Descriptions title="订单信息" layout="vertical" bordered>
                  ...
                  <Descriptions.Item label="航空公司">{msg.company}</Descriptions.Item>
                  <Descriptions.Item label="航班">{msg.orderName}</Descriptions.Item>
                  <Descriptions.Item label="出发地">{msg.startCity}</Descriptions.Item>
                  <Descriptions.Item label="目的地">{msg.endCity}</Descriptions.Item>
                  ...
                  {
                    msg.ticket &&
                    <Descriptions.Item label="票号">{msg.ticket}</Descriptions.Item>
                  }
                  <Descriptions.Item label="乘机人姓名">{msg.username}</Descriptions.Item>
                  <Descriptions.Item label="乘机人身份证号">{msg.id}</Descriptions.Item>
